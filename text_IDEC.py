...
if __name__ == '__main__':
    ...
    n_clusters = 4
    root_dir = 'data/yahoo_answers'
    n_clusters = 10
    root_dir = 'data/reuters_2/'
    n_clusters = 2
    ...
    print('Total acc is {} nmi {} ari {}'.format(text_idec_model.current_cluster_acc, text_idec_model.current_cluster_nmi, text_idec_model.current_cluster_ari))
